...
! This returns an array of M seeds, where M = N if N is odd, or N+1
! otherwise; the returned seeds have values that partition the basic
...
!=======================================================================
module random
  integer,parameter :: MaxParallelism = 32768 !!!!!!!!!! TB CHANGED
  integer,parameter :: MaxRandNumStreams = MaxParallelism 
  integer,parameter :: IRandNumSize = 4, IBinarySize = 48
  integer,parameter :: Mod4096DigitSize = 12
  !integer,parameter :: IAmountofParallelism = 128
...
contains
  ...
  !=======================================================================
  subroutine rans( NIn, StartVal, SeedArray )
    implicit none
    integer :: NIn
    integer :: StartVal
    integer,dimension( MaxRandNumStreams, IRandNumSize ) :: SeedArray
