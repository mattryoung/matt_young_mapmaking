...
subroutine read_cosmology(Omt,Omnr,Omx,OmB,h,Omcurv,Omvac,Omhdm,fhdmclus,iamcurved,dcurv)
  USE intreal_types
  Omnr=Omx+OmB+Omhdm
  Omt=Omnr+Omvac
...
subroutine Dlinear_cosmology(omtvac0,omnr0,omx0,omb0,h0,omcurv0,omvac0,omhdm0,fhdmclus0,iamcurved0,dcurv0)
  USE intreal_types
  use univer
  use univer2
  use fac
