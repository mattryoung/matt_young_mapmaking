...
contains
  ...
  subroutine mpi_initialize_alm_tools(comm_in, nsmax_in, nlmax_in, &
    ...
    call find_rings(myid, first_ring, last_ring)
    ...
    if (myid == root) then
       ...
       do i = 0, numprocs-1
          call find_rings(i, ring_procs(1,i), ring_procs(2,i))
  ...
  subroutine find_rings(myid, first_ring, last_ring)
    implicit none
